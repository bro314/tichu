...
$this->colors = array( // type
    1 => array( 'name' => clienttranslate('Swords'), 'nametr' => self::_('Swords') ),
    2 => array( 'name' => clienttranslate('Stars'), 'nametr' => self::_('Stars') ),
    3 => array( 'name' => clienttranslate('Pagodas'), 'nametr' => self::_('Pagodas') ),
    4 => array( 'name' => clienttranslate('Jade'), 'nametr' => self::_('Jade') )
);
$this->values_label = array( // type_arg
    2 => '2',
    3 => '3',
    4 => '4',
    5 => '5',
...
$this->specials_label = array( // type
