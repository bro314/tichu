...
class $ extends HTMLElement {
  ...
  static createProperty(t, s = S) {
    if (
      (s.state && (s.attribute = !1), this.o(), this.elementProperties.set(t, s), !s.noAccessor)
    ) {
      const i = Symbol(),
  ...
  requestUpdate(t, s, i) {
    if (void 0 !== t) {
      if (((i ??= this.constructor.getPropertyOptions(t)), !(i.hasChanged ?? _)(this[t], s)))
        return;
      this.T(t, s, i);
    }
  ...
  performUpdate() {
    ...
    if (!this.hasUpdated) {
      ...
      if (t.size > 0)
        for (const [s, i] of t)
          !0 !== i.wrapped || this._$AL.has(s) || void 0 === this[s] || this.T(s, this[s], i);
    }
    let t = !1;
    const s = this._$AL;
    try {
      (t = this.shouldUpdate(s)),
        t
          ? (this.willUpdate(s), this.P?.forEach((t) => t.hostUpdate?.()), this.update(s))
          : this.k();
    } catch (s) {
      throw ((t = !1), this.k(), s);
    }
...
class st {
  ...
  R(t) {
    ...
    for (const i of this._$AV)
      void 0 !== i &&
        (void 0 !== i.strings ? (i._$AI(t, i, s), (s += i.strings.length - 2)) : i._$AI(t[s])),
        s++;
  }
}
let it = class t {
...
class et {
  ...
  _$AI(t, s = this, i, e) {
    ...
    let r = !1;
    if (void 0 === n)
      (t = tt(this, t, s, 0)), (r = !V(t) || (t !== this._$AH && t !== F)), r && (this._$AH = t);
    else {
      const e = t;
      let o, h;
    ...
    class extends Ht {
      ...
      update(t, [s]) {
        ...
        return (
          ...
          (i || this.$t !== this.Tt) &&
            ((this.ct = s), (this.xt = t.options?.host), this.St((this.Tt = t.element))),
          G
        );
      }
      St(t) {
    ...
    class extends Vt {
      ...
      update(t, [s]) {
        ...
        for (const t of this.Pt)
          null == s[t] &&
            (this.Pt.delete(t), t.includes("-") ? i.removeProperty(t) : (i[t] = null));
        for (const t in s) {
          const e = s[t];
          if (null != e) {
            this.Pt.add(t);
...
class ps extends Vt {
  ...
  render(t) {
    ...
    const s = [t];
    return (
      (s.raw = s), (this.kt = { _$litType$: this.constructor.resultType, strings: s, values: [] })
    );
  }
}
