...
class action_tichu extends APP_GameAction
{
		...
		public function grandTichuBet() {
				self::setAjaxMode();
				$bet = self::getArg( "bet", AT_enum, true, false, array( '0', '200' ) );
		...
		public function tichuBet() {
				self::setAjaxMode();
				$bet = self::getArg( "bet", AT_enum, true, false, array( '0', '100' ) );
				$this->game->tichuBet();
				self::ajaxResponse( );
		}
		...
		public function confirmTichu() {
				self::setAjaxMode();
				$bet = self::getArg( "bet", AT_enum, true, false, array( '100', '200' ) );
