...
$game_options = array(
    ...
    'values' => array(
        1 => array( 'name' => totranslate('Half Game (500 points)'), 'tmdisplay' => totranslate('Half game') ),
        2 => array( 'name' => totranslate('Classic (1000 points)'), 'tmdisplay' => totranslate('Classic') ),
        3 => array( 'name' => totranslate('Long Game  (2000 points)'), 'tmdisplay' => totranslate('Long game') )
        ),
            'default' => 2
    ),
    101 => array(
            ...
            'values' => array(
                    1 => array( 'name' => totranslate( 'By table order (1st/3rd versus 2nd/4th)' )),
                    2 => array( 'name' => totranslate( 'By table order (1st/2nd versus 3rd/4th)' )),
					3 => array( 'name' => totranslate( 'By table order (1st/4th versus 2nd/3rd)' )),
    ...
    102 => array(
            ...
            'values' => array(
                    1 => array( 'name' => totranslate( 'Standard 4-player Tichu' )),
            ),
            'default' => 1
    ),
);
